...
def parse_args():
    ...
    parser.add_argument(
        "--num_classes_to_replace",
        type=int,
        default=None,
        help="Number of classes to forget",
    )
    parser.add_argument(
        "--indexes_to_replace",
        type=list,
...
########################## LSQ Quantization setting #################################
    parser.add_argument("--bitwidth",default=4,type=int,help="bitwidth for quantized model")

    parser.add_argument("--mrl",default=True,type=bool,help="")
