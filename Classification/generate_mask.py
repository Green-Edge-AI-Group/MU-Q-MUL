...
def save_gradient_ratio(data_loaders, model, criterion, args):
    ...
    for i in threshold_list:
        ...
        print('saving maps in'+os.path.join(args.save_dir, "with_{}.pt".format(i)))
        print("Generated mask keys:", hard_dict.keys())
...
if __name__ == "__main__":
    ...
    time_taken_stage1 = end_time_stage1 - start_time_stage1  # 计算时间差
    print(f"time took {time_taken_stage1:.4f} seconds")
